...
const Login = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting }) => {
      try {
        ...
        // TODO: call your login API here and check server response.
        // If you have an API, validate credentials first, then show success and redirect.
        // For now we show success and redirect after user closes the alert.
        ...
        // Redirect to home (replace history so back doesn't go to login)
        navigate("/", { replace: true });
      } catch (err) {
        // If you handle API errors, show an error Swal here.
        console.error(err);
      } finally {
        setSubmitting(false);
      }
  ...
  return (
    <div className="min-h-screen bg-background justify">
          ...
          >
            <form onSubmit={formik.handleSubmit}>
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <Link to="/forgot-password" className="text-sm text-foreground hover:text-primary">Forgot Password</Link>
              </div>
              ...
              <button
                ...
                className={`w-full py-3.5 rounded-xl font-semibold mb-6 transition-all hover-lift
                  ${formik.isSubmitting || !formik.isValid ? "bg-primary/60 text-white cursor-not-allowed" : "bg-primary text-white hover:bg-accent"}`}
              >
              ...
              <p className="text-center text-sm">
                ...
                <Link to="/register" className="text-foreground font-semibold hover:text-primary">Sign Up</Link>
              </p>
            </form>
          </motion.div>
